...
import { Plan, MarketItem, FAQItem, Testimonial, ResourceItem, BlogPost, GalleryItem, PainPointItem, ComparisonRow, Recipe, DailyMenu, Addon } from './types';
...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1626500155550-61d02c776077?q=80&w=1000&auto=format&fit=crop'
  },
  {
    id: 'professional',
    type: 'subscription',
...
export const WEEKLY_MENU: DailyMenu[] = [
  {
    day: 'Monday',
    dayBn: 'সোমবার',
    lunch: 'Rice, Dal, Jhuri Alu Bhaja, Egg Curry (2 pcs)',
    lunchBn: 'ভাত, ডাল, ঝুড়ি আলু ভাজা, ডিমের ঝোল (২ পিস)',
    dinner: 'Roti (4) / Rice, Mixed Veg, Chicken Kasha',
    dinnerBn: 'রুটি (৪) / ভাত, মিক্সড ভেজ, চিকেন কষা'
  },
  {
    day: 'Tuesday',
    dayBn: 'মঙ্গলবার',
    lunch: 'Rice, Dal, Seasonal Sabji, Fish Curry (Rui/Katla)',
    lunchBn: 'ভাত, ডাল, সবজি, মাছের ঝোল (রুই/কাতলা)',
    dinner: 'Roti (4) / Rice, Dal Fry, Jeera Alu',
    dinnerBn: 'রুটি (৪) / ভাত, ডাল ফ্রাই, জিরা আলু'
  },
  {
    day: 'Wednesday',
    dayBn: 'বুধবার',
    lunch: 'Rice, Dal, Begun Bharta, Chicken Curry (Home Style)',
    lunchBn: 'ভাত, ডাল, বেগুন ভর্তা, চিকেন কারি (ঘরোয়া)',
    dinner: 'Roti (4) / Rice, Soyabean Masala',
    dinnerBn: 'রুটি (৪) / ভাত, সয়াবিন কষা'
  },
  {
    day: 'Thursday',
    dayBn: 'বৃহস্পতিবার',
    lunch: 'Rice, Dal, Bhindi Fry, Fish Curry',
    lunchBn: 'ভাত, ডাল, ভিন্ডি ভাজা, মাছের ঝোল',
    dinner: 'Roti (4) / Rice, Tadka Dal, Paneer Masala',
    dinnerBn: 'রুটি (৪) / ভাত, তরকা ডাল, পনির মশলা'
  },
  {
    day: 'Friday',
    dayBn: 'শুক্রবার',
    lunch: 'Rice, Dal, Lau Chingri / Veg, Egg Curry',
    lunchBn: 'ভাত, ডাল, লাউ চিংড়ি / সবজি, ডিমের ঝোল',
    dinner: 'Roti (4) / Rice, Chicken Do Pyaza',
    dinnerBn: 'রুটি (৪) / ভাত, চিকেন দো পেঁয়াজা'
  },
  {
    day: 'Saturday',
    dayBn: 'শনিবার',
    lunch: 'Khichuri, Labra, Beguni, Omelette / Papad',
    lunchBn: 'খিচুড়ি, লাবড়া, বেগুনি, অমলেট / পাঁপড়',
    dinner: 'Roti (4) / Rice, Chilli Chicken (Dry)',
    dinnerBn: 'রুটি (৪) / ভাত, চিলি চিকেন (ড্রাই)'
  },
  {
    day: 'Sunday',
    dayBn: 'রবিবার',
    lunch: 'Basanti Pulao, Mutton Curry (Special) / Chicken Chaap',
    lunchBn: 'বাসন্তী পোলাও, মটন কারি (স্পেশাল) / চিকেন চাপ',
    dinner: 'Closed (Staff Holiday) or Special Order',
    dinnerBn: 'বন্ধ (স্টাফ ছুটি) বা স্পেশাল অর্ডার'
  }
];

export const ADDONS: Addon[] = [
  { id: '1', name: 'Rice Plate (~400ml)', nameBn: 'ভাত (৪০০ মিলি)', price: 10, unit: 'plate', unitBn: 'প্লেট' },
  { id: '2', name: 'Roti (Medium)', nameBn: 'রুটি (মাঝারি)', price: 2, unit: 'pc', unitBn: 'পিস' },
  { id: '3', name: 'Seasonal Sabji (~250ml)', nameBn: 'সবজি (২৫০ মিলি)', price: 20, unit: 'bowl', unitBn: 'বাটি' },
  { id: '4', name: 'Bhaja / Bada / Cutlet', nameBn: 'ভাজা / চপ / কাটলেট', price: 10, unit: 'pc', unitBn: 'পিস' },
  { id: '5', name: 'Dal (~200ml)', nameBn: 'ডাল (২০০ মিলি)', price: 10, unit: 'bowl', unitBn: 'বাটি' },
  { id: '6', name: 'Egg Curry (1pc)', nameBn: 'ডিমের ঝোল (১ পিস)', price: 20, unit: 'serving', unitBn: 'সার্ভিং' },
  { id: '7', name: 'Egg Omelette', nameBn: 'ডিম ভাজা / ওমলেট', price: 10, unit: 'pc', unitBn: 'পিস' },
  { id: '8', name: 'Chicken Curry (1pc)', nameBn: 'চিকেন কারি (১ পিস)', price: 30, unit: 'pc', unitBn: 'পিস' },
  { id: '9', name: 'Fish Curry (1pc)', nameBn: 'মাছ (১ পিস)', price: 30, unit: 'pc', unitBn: 'পিস' },
  { id: '10', name: 'Paneer Gravy', nameBn: 'পনির গ্রেভি', price: 30, unit: 'serving', unitBn: 'সার্ভিং' },
  { id: '11', name: 'Tiffin / Breakfast', nameBn: 'টিফিন / ব্রেকফাস্ট', price: 25, unit: 'meal', unitBn: 'মিল' },
  { id: '12', name: 'Maggi / Waiwai (Veg)', nameBn: 'ম্যাগি / ওয়াইওয়াই (ভেজি)', price: 20, unit: 'bowl', unitBn: 'বাটি' },
  { id: '13', name: 'Maggi / Waiwai (Egg)', nameBn: 'ম্যাগি / ওয়াইওয়াই (ডিম)', price: 30, unit: 'bowl', unitBn: 'বাটি' },
  { id: '14', name: 'Milk (200ml)', nameBn: 'দুধ (২০০ মিলি)', price: 20, unit: 'glass', unitBn: 'গ্লাস' },
  { id: '15', name: 'Tea (Large)', nameBn: 'চা (বড়)', price: 10, unit: 'cup', unitBn: 'কাপ' },
  { id: '16', name: 'Tea (Small)', nameBn: 'চা (ছোট)', price: 5, unit: 'cup', unitBn: 'কাপ' },
  { id: '17', name: 'Coffee', nameBn: 'কফি', price: 20, unit: 'cup', unitBn: 'কাপ' },
];
